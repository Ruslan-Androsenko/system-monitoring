...
type MonitoringResponse struct {
	...
	DiskLoad    *DiscLoad `protobuf:"bytes,3,opt,name=disk_load,json=diskLoad,proto3" json:"disk_load,omitempty"`
	DiskInfo    *DiscInfo `protobuf:"bytes,4,opt,name=disk_info,json=diskInfo,proto3" json:"disk_info,omitempty"`
}
...
func (x *MonitoringResponse) GetDiskLoad() *DiscLoad {
	if x != nil {
		return x.DiskLoad
	}
	return nil
...
func (x *MonitoringResponse) GetDiskInfo() *DiscInfo {
	if x != nil {
		return x.DiskInfo
	}
	return nil
...
type DiscLoad struct {
	...
	KbsPerSecond      float64 `protobuf:"fixed64,2,opt,name=kbs_per_second,json=kbsPerSecond,proto3" json:"kbs_per_second,omitempty"`
}

func (x *DiscLoad) Reset() {
	*x = DiscLoad{}
	if protoimpl.UnsafeEnabled {
...
func (x *DiscLoad) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DiscLoad) ProtoMessage() {}

func (x *DiscLoad) ProtoReflect() protoreflect.Message {
	mi := &file_proto_monitoring_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DiscLoad.ProtoReflect.Descriptor instead.
func (*DiscLoad) Descriptor() ([]byte, []int) {
	return file_proto_monitoring_proto_rawDescGZIP(), []int{3}
}

func (x *DiscLoad) GetTransferPerSecond() float64 {
	if x != nil {
...
func (x *DiscLoad) GetKbsPerSecond() float64 {
	if x != nil {
		return x.KbsPerSecond
	}
	return 0
}
...
func (x *DiscInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DiscInfo) ProtoMessage() {}

func (x *DiscInfo) ProtoReflect() protoreflect.Message {
	mi := &file_proto_monitoring_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DiscInfo.ProtoReflect.Descriptor instead.
func (*DiscInfo) Descriptor() ([]byte, []int) {
	return file_proto_monitoring_proto_rawDescGZIP(), []int{4}
}

func (x *DiscInfo) GetUsageSize() float64 {
	if x != nil {
		return x.UsageSize
	}
	return 0
...
func (x *DiscInfo) GetUsageInode() float64 {
	if x != nil {
		return x.UsageInode
	}
	return 0
...
var file_proto_monitoring_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x59, 0x0a, 0x11, 0x4d, 0x6f, 0x6e, 0x69,
	...
	,
...
var file_proto_monitoring_proto_goTypes = []interface{}{
	...
	(*DiscLoad)(nil),           // 3: DiscLoad
	(*DiscInfo)(nil),           // 4: DiscInfo
}
var file_proto_monitoring_proto_depIdxs = []int32{
	2, // 0: MonitoringResponse.cpu_load:type_name -> CpuLoad
	3, // 1: MonitoringResponse.disk_load:type_name -> DiscLoad
	4, // 2: MonitoringResponse.disk_info:type_name -> DiscInfo
	0, // 3: SystemMonitoring.Metrics:input_type -> MonitoringRequest
	1, // 4: SystemMonitoring.Metrics:output_type -> MonitoringResponse
